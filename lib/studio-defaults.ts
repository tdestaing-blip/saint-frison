export const studioDefaults = {
  ...
  processSteps: [
    {
      title: "Échanger",
      text: "Comprendre le projet, les usages, les contraintes et les intentions.",
    },
    {
      title: "Rechercher",
      text: "Explorer les fibres, les couleurs, les structures et les possibilités de tissage.",
    },
    {
